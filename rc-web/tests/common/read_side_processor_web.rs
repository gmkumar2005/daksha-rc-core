...
mod read_side_dispatch {
    ...
    use definitions_manager_lib::read_side_processor::ProjectionOffsetStoreRepository;
    use definitions_manager_lib::read_side_processor::{EventProcessorActor, GetOffsetCount, ProjectionOffsetStore, SimpleReadSideProcessor};
